...
<html lang="en">
  ...
  <body data-bs-theme="dark" class="d-flex flex-column min-vh-100">
        ...
        <div class="container">
            ...
            <h3 class=" text-center">Ajouter un nouveau Client</h3>
            </br></br></br>
            ...
            @endif
              ...
              <form method="post" action="{{url('save-client')}}" class="needs-validation" novalidate >
                @csrf
                <div class="form-group row ">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email"  name="email" pattern="[^@\s]+@[^@\s]+\.[^@\s]+" title="Invalid email address" size="30" required class="form-control"  placeholder="name@example.com">
                      <div class="invalid-feedback">Champ Invalide !</div>
                    </div>
                    </br>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback">Champ Invalide !</div>
                        @else
                            <strong style="color:red;">Coaches not available.</strong>
                        @endif
                    </div>
                    </br>
